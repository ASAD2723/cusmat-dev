	...
	return (
		<section className="footer-sec py-5">
			<div className="custom-container">
				<div className="footer-heading-sec">
					<h2 className="H1 pb-3" style={{fontSize:"50px"}}>
						Explore Skilling Metaverse <br /> For Your Business
					</h2>
					<br />
					<Link className="pt-4" to="/request-demo">
				...
				<div className="row  px-0 py-md-1 py-lg-5 m-0 gy-5">
					...
					<div className="col-lg-4 col-md-6 p-0">
						...
						<div className="d-flex py-4 pb-2">
							<img src="/images/home/mail.svg" alt="mail" className="my-auto pt-1" />
							
							<h5 className="H5 my-auto ps-2">
								<a href="mailto:contact@cusmat.com" className="text-white pb-2">
									contact@cusmat.com
								</a>
							</h5>
						</div>
						<div className="d-flex pt-2">
							<h5 className="H5 my-auto pb-2"> Follow us on</h5>
							<a
