      ...
      <section>
        ...
        <section>
          ...
          <div className="custom-container py-5 color-2">
            <h4 className="H4" style={{ fontSize: "20px" }}>
              ...
              foggy/ rainy weather & night driving. The simulator is ideal for
              new as well as experienced operators. New operators can get
              familiarized with the truck controls and learn the basic driving
              techniques. Advanced operators can improve their skills as the
              simulator is designed in such a way to increase productivity, fuel
              efficiency and overall safety levels.
            </h4>
          </div>
          <br />
          <br />
        ...
        <section className="custom-container working-sec">
          ...
          <div className="working-container pb-3">
            <iframe
              src="https://drive.google.com/file/d/1zWJNJVjfqVFl6X7l0WuNqDyUXYW2_pAp/preview"
              width="1100"
              height="600"
              allow="autoplay"
            ></iframe>
